...
/*                                                                            */
/*    Topic: Graph - Minimum Spaning Tree                                     */
/*                                                                            */
/*    File name:  praveen-assignment-20.c                                     */
/*                                                                            */
/*    Date: 12/18/2016                                                        */
/*                                                                            */
/*    Objective :                                                             */
/*     Minimum Spanning Tree for given graph                                  */
/******************************************************************************/
...
main (void)
{
    ...
    insertEdge(G, 0, 2,  65, 0);
    insertEdge(G, 0, 3,  85, 0);
    insertEdge(G, 1, 2,  30, 0);
    insertEdge(G, 1, 3,  40, 0);
    insertEdge(G, 2, 4,  60, 0);
    insertEdge(G, 2, 6, 120, 0);
    insertEdge(G, 3, 4,  75, 0);
    insertEdge(G, 3, 5,  90, 0);
    insertEdge(G, 3, 6, 130, 0);
    insertEdge(G, 4, 6,  55, 0);
    insertEdge(G, 5, 6,  50, 0);
    insertEdge(G, 5, 7,  70, 0);
    insertEdge(G, 6, 7,  40, 0);
#else
    G = readInput();
#endif	
    ...
    //printGraph(G);
    //printHeader(0);
	printf("Cost matrix for given graph:\n");
	getWeightMatrixFrmG(G);
	printWeightArray(G, W);
    dijkstra(G, 0, distance, visited); /* Dikjastra's Algorithm */

	printf("\nMinimum Spanning Tree (MST) on G\n");
	printf("Minimum Spanning Tree (MST) edges are...\n");
	kruskal(G);

	printf("\n\nFlyod's all pair minimum cost\n");
