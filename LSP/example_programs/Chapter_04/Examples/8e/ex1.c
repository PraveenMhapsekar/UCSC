// sourced from http://www.kernel.org/doc/man-pages/online/pages/man3/pthread_setschedparam.3.html
...
int main(int argc, char *argv[]) {
	...
	/* Optionally set scheduling attributes of main thread, and 
	...
	if (inheritsched_str != NULL) {
			...
			switch (inheritsched_str[0]) {
				case 'e': inheritsched = PTHREAD_EXPLICIT_SCHED; break;
				case 'i': inheritsched = PTHREAD_INHERIT_SCHED; break;
				default: usage(argv[0], "Value for -i must be 'e' or 'i'\n");
			}
